...
def setup(analyses):
    ...
    # Short Field   
    short_field_mission = short_field_setup(analyses)
    missions.short_field = short_field_mission

    # ------------------------------------------------------------------
    #   Mission for Maximum Range
    # ------------------------------------------------------------------    
    max_range = max_range_setup(analyses)
    missions.max_range = max_range
...
def base(analyses):
    ...
    ## ------------------------------------------------------------------
    ##   Final Climb Segment: Constant Speed, Constant Throttle
    ## ------------------------------------------------------------------
